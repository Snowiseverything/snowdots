    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            sourceComponent: MaterialIcon {
                ...
                color: {
                    if (healthIcon.internet !== "ok") return Colours.palette.m3error;
                    if (healthIcon.snowpi !== "up" || healthIcon.dns !== "ok") return Colours.palette.m3tertiary;
                    return root.colour;
                }
                animate: true
                text: "lens"
                    ...
                    stdout: StdioCollector {
                        onStreamFinished: {
                            for (const line of text.trim().split('\n')) {
                                ...
                                if (key === 'snowpi') healthIcon.snowpi = val;
                                else if (key === 'internet') healthIcon.internet = val;
                                else if (key === 'dns') healthIcon.dns = val;
                            }
                        }
                    }
                }
